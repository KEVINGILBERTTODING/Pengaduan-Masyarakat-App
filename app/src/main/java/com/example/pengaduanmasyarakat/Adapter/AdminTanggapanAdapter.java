...
public class AdminTanggapanAdapter extends RecyclerView.Adapter<AdminTanggapanAdapter.ViewHolder> {

    Context context;
    List<TanggapanModel> tanggapanModelList;

    public AdminTanggapanAdapter(Context context, List<TanggapanModel> tanggapanModelList) {
    ...
    @NonNull
    @Override
    public AdminTanggapanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdminTanggapanAdapter.ViewHolder holder, int position) {
