...
public class AdminDetailPengaduanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_detail_pengaduan, container, false);
        ...
        btnTanggapan = view.findViewById(R.id.btnTanggapan);
        ...
        if (statusPengaduan.equals("tidak_valid")) {
            btnTanggapan.setEnabled(false);
        } else if (statusPengaduan.equals("selesai")) {
            btnTanggapan.setEnabled(false);
        }
        ...
        btnTanggapan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment = new InsertTanggapanFragment();
    ...
    private void fullScreenImage(ImageView img, String resource) {
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                f.setArguments(b);
                getFragmentManager().beginTransaction().replace(R.id.frame_admin_container, f).addToBackStack(null).commit();
            }
        });
